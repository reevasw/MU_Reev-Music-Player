...
import com.example.mureev.databinding.FavouriteViewBinding
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        if (playNext) {
            ...
            holder.root.setOnLongClickListener {
                ...
                bindingMF.playNextBtn.text = "Hapus dari Antrean"
                bindingMF.playNextBtn.setOnClickListener {
                    if (position == PlayerActivity.songPosition)
                        Snackbar.make(
                            ...
                            "Tidak dapat menghapus lagu yang sedang diputar.", Snackbar.LENGTH_SHORT
                        ).show()
                    else {
                        if (PlayerActivity.songPosition > position) --PlayerActivity.songPosition
